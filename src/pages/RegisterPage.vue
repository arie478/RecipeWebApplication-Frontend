<template>
  <div class="container">
    <b-card border-variant="secondary" header-border-variant="secondary" header="Register" align="center">
      <b-card-text>
        <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
          ...
          <b-form-group id="input-group-lastName" label-cols-sm="3" label="Last Name:" label-for="lastame">
          ...
          <b-button type="submit" variant="primary" style="width:310px;" class="ml-5">Register</b-button>
          <div class="mt-2">
      ...
      async Register() {
        try {
          const response = await this.axios.post(
            ...
            "https://foodisgood.cs.bgu.ac.il/Register",
            {
